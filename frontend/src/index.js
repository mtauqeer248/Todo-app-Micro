class TodoApp {
    ...
    bindEvents() {
        ...
        // Todo form events
        document.getElementById('todo-form').addEventListener('submit', this.handleCreateTodo.bind(this));
    }
        ...
        container.innerHTML = todos.map(todo => `
            <div class="todo-item ${todo.completed ? 'completed' : ''}">
                ...
                <div class="todo-actions">
                    <button class="btn-complete" onclick="app.toggleTodo(${todo.id}, ${!todo.completed})">
                        ${todo.completed ? 'Mark Incomplete' : 'Mark Complete'}
                    </button>
                    <button class="btn-edit" onclick="app.editTodo(${todo.id}, '${this.escapeHtml(todo.title)}', '${this.escapeHtml(todo.description || '')}')">
                        Edit
                    </button>
