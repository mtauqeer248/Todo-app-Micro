...
export async function createTodoForUser(userUuid: string, todoData: CreateTodoRequest) {
  return await TodoModel.create(userUuid, todoData);
}

export async function updateUserTodo(todoId: number, userUuid: string, updateData: UpdateTodoRequest) {
